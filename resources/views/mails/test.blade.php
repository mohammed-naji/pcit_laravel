...
<body>
    <div class="m_-5992786312773600200body"
        style="min-width:100%;width:100%!important;background-color:#f8fafa;margin:0;padding:32px 0">
                ...
                <tr style="padding:0">
                    <td style="border-collapse:collapse!important;word-break:break-word;min-width:100%;width:100%!important;margin:0;padding:0"
                        ...
                        <table
                            ...
                            class="m_-5992786312773600200email-body" bgcolor="#fff">

                            <tbody>
                                <tr style="padding:0">
                                    <td style="border-collapse:collapse!important;word-break:break-word;padding:24px 32px 30px"
                                        class="m_-5992786312773600200content" align="left" valign="top">


                                        <p style="font-size:14px;padding-bottom:10px;margin:0">Hi Malak Hajjaj</p>

                                        <p style="font-size:14px;padding-bottom:10px;margin:0">There is a neww contact
                                            us message with the following data: </p>
                                        ...
                                        <p style="font-size:14px;padding-bottom:10px;margin:0"><strong>Subject:</strong>
                                            {{ $data['subject'] }}
                                        </p>
                                        ...
                                        <p style="font-size:14px;padding-bottom:10px;margin:0">If it was not you, please
                                            contact support at <a href="mailto:support@mailtrap.io"
                                                style="color:#4c83ee!important" target="_blank">support@mailtrap.io</a>.
                                        </p>
                                ...
                                <tr style="padding:0">
                                    <td style="border-collapse:collapse!important;word-break:break-word;padding:0 32px 24px"
                                        class="m_-5992786312773600200inner-footer" align="left" valign="middle">
                                                            ...
                                                            <tbody>
                                                                <tr style="padding:0">
                                                                    <td
                                                                        ...
                                                                        <br>
                                                                        <strong>Mohammed Naji </strong><br>
                                                                        <span style="color:#a3abb4;font-size:10px"><a
                                                                                href="mailto:malqumbuz@gmail.com"
                                                                                target="_blank">malqumbuz@gmail.com</a></span>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
